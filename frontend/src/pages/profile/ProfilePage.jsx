...
const ProfilePage = () => {
  ...
  const [feedType, setFeedType] = useState("user"); // in case I want to add more functionality
  ...
  // refetch whenever the username change
  useEffect(() => {
    refetch();
  }, [username, refetch]);
        ...
        <div className="flex flex-col">
          {!isLoading && !isRefetching && user && (
            <>
              ...
              <div className="flex flex-col gap-4 mt-14 px-4 border-b border-gray-700 pb-4">
                <div className="flex flex-col">
